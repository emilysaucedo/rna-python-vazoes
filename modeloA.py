# -*- coding: utf-8 -*-
"""
Created on Thu Mar 16 19:40:27 2023
...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 12 22:00:24 2023
...
plt.title('Gráfico de Previsão de Treinamento - Modelo A ')
...
plt.title('Gráfico de Previsão de Validação - Modelo A')
plt.xlabel('Período de Tempo (dias)')
plt.ylabel('Vazão alfuente (m³/s)')
...
train_results.to_csv('modeloA_train_results.csv', index=False, sep=";", float_format='%.2f')
val_results.to_csv('modeloA_val_results.csv', index=False, sep=";", float_format='%.2f')